 ...
 describe('User Authentication and Actions on web page', () => {
  ...
  it('should not move to Login page if username and password are not entered',()=>
  {
  ...
  //should move to sign up page if login is unsuccessful
     ...
     it('verify login is unsuccessfull and redirect to Signup Page to create new account and login with correct credentials to check the list of fields listed in web page are editable', () => {
      ...
      //The user should be redirected to the signin page if not authenticated
        ...
        // Verify that there is an error message indicating unsuccessful login (replace with actual error message selector)
      ...
      // user redirected to 'Cypress Automation Testing Practice Page'
      //cy.title().should('include', 'Cypress Automation Testing Practice Page');
